...
void graphOptions ()
{
   ...
   // outtextxy(100, 300, "2. Implement algorithm in a Random graph");
    outtextxy(100, 450, "2. Implement algorithm in a User Input graph");
...
void graphOptionsbfsdfstopo ()
{
    ...
    outtextxy(100, 150, "1. Implement sprint  user input");
    outtextxy(100, 300, "2. Implement fixed graph");
...
void showList()
{
    ...
    y += 40;
    outtextxy(100, y, "floywdwarshall");
    y += 40;
    outtextxy(100, y, "edmondkarp");
    y+=40;
    outtextxy(100, y, "karger");
    ...
    while (1)
    {
        ...
        if (ismouseclick(WM_LBUTTONDOWN))
        {
            ...
            else if (x > 100 && x < 500 && y > 300 && y < 320)
            {
                ...
                COUNT = 0; // COUNT changed beacuse it will indicate that it will
            ...
            else if (x > 100 && x < 380 && y > 500 && y < 520)
            {
              ...
              else if (x > 100 && x < 670 && y > 540 && y < 560)
            {
                // button was clicked
                cleardevice();
                delay(100);
                ...
                settextstyle(GOTHIC_FONT, HORIZ_DIR, 3);
                outtextxy(400, 30, "khan topological");
